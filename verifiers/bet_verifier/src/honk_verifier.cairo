...
use super::honk_verifier_circuits::{
    is_on_curve_excluding_infinity_bn254, run_GRUMPKIN_ZKHONK_PREP_MSM_SCALARS_SIZE_8_circuit,
    run_GRUMPKIN_ZK_HONK_EVALS_CONS_DONE_SIZE_8_circuit,
    run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_8_circuit,
    run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_8_circuit,
    run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_8_PUB_18_circuit,
};
...
mod UltraKeccakZKHonkVerifier {
    ...
    use super::{
        ...
        run_GRUMPKIN_ZKHONK_PREP_MSM_SCALARS_SIZE_8_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_DONE_SIZE_8_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_8_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_8_circuit,
        run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_8_PUB_18_circuit, vk,
    };
    ...
    impl IUltraKeccakZKHonkVerifier of super::IUltraKeccakZKHonkVerifier<ContractState> {
        fn verify_ultra_keccak_zk_honk_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_8_PUB_18_circuit(
            ...
            let (vanishing_check, diff_check) = run_GRUMPKIN_ZK_HONK_EVALS_CONS_DONE_SIZE_8_circuit(
            ...
            let mut scalars: Span<u384> = array![
                ...
                scalar_44, scalar_45, scalar_46, scalar_47, transcript.shplonk_z.into(), scalar_48,
            ]
                .span();

            // Check input points are on curve.
            // Skip the first 28 points as they are from VK and keep the last 20 proof points
            for point in points.slice(28, 20) {
                assert(
